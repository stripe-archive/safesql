...
import (
	...
	"github.com/stripe/safesql/Godeps/_workspace/src/golang.org/x/tools/container/intsets"
	...
	"github.com/stripe/safesql/Godeps/_workspace/src/golang.org/x/tools/go/types/typeutil"
)
